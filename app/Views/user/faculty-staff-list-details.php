<?php
    ...
    if (!$list) {
        ...
        header('Location: ' . BASE_URL . '/user/faculty-staff-list.php?type=' . $type);
        exit();
    }
    ...
    <div class="admin-content">
        <div class="content-header">
            <div class="header-actions">
                <a href="<?php echo BASE_URL; ?>/user/faculty-staff-list.php?type=<?php echo $type; ?>" class="btn">Back to List</a>
            </div>
        </div>
