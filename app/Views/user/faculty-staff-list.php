...
<div class="admin-layout">
    <?php include ROOT_PATH . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'sidebar-user.php'; ?>
                    ...
                    <tbody>
                        <?php foreach ($lists as $list): ?>
                            <tr>
                                <?php if ($type === 'faculty' || $type === 'staff'): ?>
                                    <td>
                                        <a href="<?php echo BASE_URL; ?>/user/faculty-staff-list-details.php?id=<?php echo $list['id']; ?>&type=<?php echo $type; ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo BASE_URL; ?>/user/faculty-staff-list-details.php?id=<?php echo $list['id']; ?>&type=<?php echo $type; ?>" class="list-name">
                                            <?php echo $list['name']; ?>
                                        </a>
                                    </td>
